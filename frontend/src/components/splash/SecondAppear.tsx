...
import VectorWord from './VectorWord';
  ...
  return (
    <SecondAppearStyle $delay={delay}>
      ...
      <VectorWordWrapper $delay={delay}>
        <VectorWord icon={VectorWordIcon} />
      </VectorWordWrapper>
    </SecondAppearStyle>
  );
}
