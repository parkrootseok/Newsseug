...
public class HistoryController {
	...
	public ResponseEntity<Result<SlicedResponse<ListHistoryResponse>>> getMemberHistories(@AuthenticationPrincipal CustomUserDetails userDetails, @RequestParam("page") int page) {
