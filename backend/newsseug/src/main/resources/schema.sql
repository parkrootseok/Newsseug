...
PARTITION BY LIST COLUMNS (category) (
    PARTITION p_accident VALUES IN ('ACCIDENT'),
    PARTITION p_economy VALUES IN ('ECONOMY'),
    PARTITION p_politics VALUES IN ('POLITICS'),
    PARTITION p_science VALUES IN ('SCIENCE'),
    PARTITION p_society VALUES IN ('SOCIETY'),
    PARTITION p_sports VALUES IN ('SPORTS'),
    PARTITION p_world VALUES IN ('WORLD')
);
